...
**Driving adapters** (left): initiate actions on the application. They _call_ use cases.
**Driven adapters** (right): the application reaches out to them. They _implement_ port interfaces.
